...
class OpenRouterProvider(BaseProvider):
    ...
    def generate(
        ...
        """
        # Get the model from kwargs, default to 'openai/gpt-3.5-turbo'
        model = kwargs.get("model", "openai/gpt-3.5-turbo")

        # Handle OpenRouter model prefixing
        # If the model starts with 'openrouter/', remove it for the API call
        # but keep it for internal tracking
        ...
        try:
            ...
            payload = {
                ...
                **{
                    ...
                    if k not in ["model", "referer", "title"]
                },
            }
            ...
            return {
                "source": "openrouter",
                "model": internal_model,  # Return the internal model name for tracking
    ...
    def get_models(self) -> Dict[str, Any]:
        ...
        return {"provider": "openrouter", "models": model_ids}
