			...
			<div id="projectsSec" class="w-5/5 h-2/5">
				...
				<div id="projects" class="flex w-max overflow-x-auto p-2">
					{#each projects as project}
						<div
							class="projectCont m-0.5 mx-1.5 h-64 w-48 rounded-lg bg-dark-surfaceContainerHighest text-dark-onSurface transition-all hover:scale-105 active:scale-100"
						>
							<img src="/src/assets/img/byteport copy.png" alt="BytePort" class="h-5/5 p-2" />
