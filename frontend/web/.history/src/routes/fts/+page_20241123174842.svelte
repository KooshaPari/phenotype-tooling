<script lang="ts">
	...
	onMount(() => {
		...
		ftsheadTxt = 'Welcome.';
		visible = true;
		const ftsCont = document.querySelector('#ftsCont');
		const actionBtn = document.querySelector('#actionBtn');startBtn = document.querySelector('#startBtn');
	});
