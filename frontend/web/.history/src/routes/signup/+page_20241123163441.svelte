...
<style>
	#signCont form > div > input {
		@apply active:bg-dark-SurfaceContainer my-2 rounded-full bg-dark-surfaceContainerHigh text-dark-onSurface placeholder-dark-onSurfaceVariant hover:bg-dark-surfaceContainerHighest;
		border: none;
	}
