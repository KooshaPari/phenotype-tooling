...
<style>
	#signCont form > div > input {
		@apply my-2 rounded-full bg-dark-surfaceContainerHigh text-dark-onSurface placeholder-dark-onSurfaceVariant hover:bg-dark-surfaceContainerHighest active:bg-dark-surfaceContainer;
		border: none;
	}
