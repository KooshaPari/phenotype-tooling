...
class _AuthWrapperState extends State<AuthWrapper> {
  ...
  bool _wasAuthenticated = false; // Initialized here
  ...
  Widget build(BuildContext context) {
    ...
    if (!_wasAuthenticated && isAuthenticated && !_checking) {
      ...
      WidgetsBinding.instance.addPostFrameCallback((_) {
        if (mounted) { // Ensure the widget is still in the tree
          ...
          // with the home route.
          debugPrint("AuthWrapper: Navigating to /home"); // Add debug print
          Navigator.pushReplacementNamed(context, '/home');
        }
      });
    }
    // Update the previous state *before* the build method returns
    // to correctly capture the state for the *next* build cycle.
    ...
    // If navigation to /home is pending (scheduled in addPostFrameCallback),
    // this might briefly show AuthScreen or widget.child depending on isAuthenticated
    // before the navigation actually happens. This is generally acceptable.
