...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      // AuthWrapper determines whether to show AuthScreen or MyHomePage
      home: const AuthWrapper(
        child: MyHomePage(), // Pass MyHomePage as the child for authenticated state
      ),
    );
  }
}
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  IconData _getIconForPage(int index) {
    switch (index) {
      ...
      case 3:
        return Icons.analytics; // Patterns (Replaced pattern_detected)
      case 4:
