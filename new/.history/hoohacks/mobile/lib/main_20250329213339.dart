...
void main() async { // Make main async
  ...
  try {
    ...
    final authService = AuthService(); // Get singleton instance
    await authService.init(); // Initialize early for web onLoad check
  } catch (e) {
    // Catch errors during dotenv loading or Auth init
