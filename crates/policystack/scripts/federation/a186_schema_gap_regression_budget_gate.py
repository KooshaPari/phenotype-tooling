...
def fail(message: str) -> None:
    print(f"E186 consistency rollforward stability budget gate failed: {message}", file=sys.stderr)
    raise SystemExit(2)
...
def main() -> int:
    ...
    parser.add_argument("--max-consistency-rollforward-seconds", type=float, default=304.0)
