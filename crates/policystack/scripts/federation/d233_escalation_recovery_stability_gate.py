...
def fail(message: str) -> None:
    print(f"E233 escalation recovery window budget gate failed: {message}", file=sys.stderr)
    raise SystemExit(2)
...
def main() -> int:
    ...
    if not rows:
        fail("E233 empty escalation data")
    ...
    if window_over_budget_count > args.max_window_over_budget_count:
        fail(
            f"E233 window_over_budget_count={window_over_budget_count} > "
