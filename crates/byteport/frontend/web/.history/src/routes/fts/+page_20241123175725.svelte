			...
			<div in:fly={{ y: 50, duration: 2000 }} out:fade id="ftsOuterCont">
				...
				{#if stage === 0}
					<div class="flex flex-col items-center justify-center">
						...
						<input type="text" placeholder="AWS Access Key ID" class="mb-2 p-2 border rounded" />
						<input type="password" placeholder="AWS Secret Access Key" class="mb-2 p-2 border rounded" />
					</div>
				{:else if stage === 1}
					<div class="flex flex-col items-center justify-center">
						<h3>OpenAI Credentials</h3>
						<input type="text" placeholder="OpenAI API Key" class="mb-2 p-2 border rounded" />
					</div>
				{:else if stage === 2}
					<div class="flex flex-col items-center justify-center">
						<h3>Connect to Your Portfolio</h3>
						<input type="text" placeholder="Portfolio Endpoint URL" class="mb-2 p-2 border rounded" />
					</div>
				{:else}
					<div class="flex flex-col items-center justify-center">
