<script>
	...
	function firstTimeSetup() {
		...
		addtl = true;
		visible = false;
		document.getElementById('ftsHeadTxt').textContent =
...
>
	{#if visible}
		<h1
			...
			out:fade
			id="ftsHeadTxt"
			class="ftsHeadText my-2 w-screen text-center text-6xl text-dark-primary transition-all transition-all hover:text-dark-onSurface"
		>
			Welcome.
		</h1>
		<h2
		...
		{#if addtl}
			<div in:fly={{ y: 50, duration: 2000 }} out:fade id="ftsCont">
				<button
					id="actionBtn"
