			...
			<div id="projectsSec" class="w-5/5 h-2/5 overflow-y-visible">
				...
				<div id="projects" class="flex w-max overflow-visible p-2">
					{#each projects as project}
						<div
							class="projectCont m-0.5 mx-1.5 h-64 w-48 overflow-visible rounded-lg bg-dark-surfaceContainerHigh text-dark-onSurface transition-all hover:-translate-y-2 hover:scale-105 active:translate-y-1 active:scale-100"
						>
							<img
