...
<div class="flex h-screen w-screen overflow-x-scroll bg-dark-surface" id="mainDashPar">
	<div
	...
	<div id="body" class="w-4/5">
		...
		<div id="mainBody">
			<div id="instanceSec" class="w-5/5 overlfow-x-scroll h-2/5">
			...
			<div id="projectsSec" class="w-5/5 h-2/5 overflow-y-visible">
				...
				<div id="projects" class="flex w-max overflow-y-visible overflow-x-scroll p-2">
