	...
	<div id="body" class="w-4/5">
		...
		<div id="mainBody">
			...
			<div id="projectsSec" class="w-5/5 h-2/5 overflow-y-visible">
				...
				<div id="projects" class="flex w-max overflow-visible p-2">
					{#each projects as project}
						...
						>
							<img src="/src/assets/img/byteport copy.png" alt="BytePort" class="bg-dark-surfaceContainerHighest h-5/5 p-2" />
