	...
	<div id="body" class="w-4/5">
		...
		<div id="mainBody">
			<div id="instanceSec" class="w-5/5 h-2/5">
				...
				<div id="instances" class="flex w-max overflow-x-scroll p-2">
					{#each instances as instance}
						<div
							class="m-0.5 mx-1.5 h-64 w-48 overflow-x-scroll rounded-full bg-dark-surfaceContainerHigh text-dark-onSurface transition-all hover:-translate-y-2 hover:scale-105 active:translate-y-1 active:scale-100"
						>
							<img
			...
			<div id="projectsSec" class="w-5/5 h-2/5 overflow-y-visible">
				...
				<div id="projects" class="flex w-max overflow-visible overflow-x-scroll p-2">
