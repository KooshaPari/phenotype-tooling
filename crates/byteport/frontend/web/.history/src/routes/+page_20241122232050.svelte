...
<div class="flex h-screen w-screen bg-dark-surface" id="mainDashPar">
	...
	<div id="body" class="w-4/5">
		...
		<div id="mainBody">
			...
			<div id="projectsSec" class="w-5/5 h-2/5 overflow-y-visible">
				<h1 class="p-2 text-dark-secondary">Projects</h1>
				<div id="projects" class="flex w-max overflow-x-auto overflow-y-visibl overflow-visible p-2">
					{#each projects as project}
						<div
							class="projectCont m-0.5 mx-1.5 h-64 w-48 overflow-visible rounded-lg bg-dark-surfaceContainerHighest text-dark-onSurface transition-all hover:-translate-y-2 hover:scale-105 active:translate-y-1 active:scale-100"
						>
							<img src="/src/assets/img/byteport copy.png" alt="BytePort" class="h-5/5 p-2" />
