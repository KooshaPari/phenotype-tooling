# Security Policy - phenotype-tooling
...
If you discover a security vulnerability in `phenotype-tooling`, please report it privately:
...
In scope:
- The `phenotype-tooling` source tree on the default branch
