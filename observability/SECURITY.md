# Security Policy - PhenoObservability
...
If you discover a security vulnerability in `PhenoObservability`, please report it privately:
...
In scope:
- The `PhenoObservability` source tree on the default branch
