# Absorbed from Stashly (post-deletion)

**Source:** `KooshaPari/Stashly` (archived and deleted from GitHub 2026-06-21)
**Target:** `phenotype-tooling/docs/absorbed-from-Stashly/`
