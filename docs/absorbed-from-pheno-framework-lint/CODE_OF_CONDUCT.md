...
the **pheno-framework-lint** community a harassment-free experience for
...
inappropriate, threatening, harmful, or offensive.
...
other channels — and also applies when an individual is officially
...
repository's contact channel (see `SECURITY.md` for the private
disclosure address). All complaints will be reviewed and investigated
promptly and fairly.
