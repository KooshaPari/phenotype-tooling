# Absorbed from pheno-harness (post-deletion)

**Source:** `KooshaPari/pheno-harness` (archived and deleted from GitHub 2026-06-21)
**Target:** `phenotype-tooling/docs/absorbed-from-pheno-harness/`
