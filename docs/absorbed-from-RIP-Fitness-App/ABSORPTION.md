# Absorbed from RIP-Fitness-App (post-deletion)

**Source:** `KooshaPari/RIP-Fitness-App` (archived and deleted from GitHub 2026-06-21)
**Target:** `phenotype-tooling/docs/absorbed-from-RIP-Fitness-App/`
