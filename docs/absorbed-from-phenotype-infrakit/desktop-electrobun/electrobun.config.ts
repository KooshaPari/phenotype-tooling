 ...
 *   phenoRouterMonitor         e.g. "MyApp"
 *   com.phenotype.phenoroutermonitor           e.g. "com.example.myapp"
 *   0.1.0      e.g. "0.1.0"
...
const APP_NAME = "phenoRouterMonitor";
const APP_ID = "com.phenotype.phenoroutermonitor";
