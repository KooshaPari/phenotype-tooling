# Absorbed from pheno-context (post-deletion)

**Source:** `KooshaPari/pheno-context` (deleted from GitHub 2026-06-21)
**Target:** `phenotype-tooling/docs/absorbed-from-pheno-context/`
