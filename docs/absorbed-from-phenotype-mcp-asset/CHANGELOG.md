...
All notable changes to `phenotype-mcp-asset` will be documented here.
Format follows [Keep a Changelog](https://keepachangelog.com/en/1.1.0/).
This project adheres to [Semantic Versioning](https://semver.org/spec/v2.0.0.html).

## [0.3.0] — 2026-06-18

### Changed — **Extracted from McpKit**

This is the **initial fleet-wide release** of `phenotype-mcp-asset` as a
standalone library crate. Prior to 0.3.0, this code lived as a workspace
member of [`KooshaPari/McpKit`](https://github.com/KooshaPari/McpKit)
(`rust/phenotype-mcp-asset`, v0.2.0).

- **Renamed**: same crate name (`phenotype-mcp-asset`) preserved for continuity
- **Version bumped**: 0.2.0 → 0.3.0 (semver minor bump for the extraction event)
- **Repository**: `KooshaPari/phenotype-mcp-asset` (new standalone repo)
...
- **Deps**: removed unused `phenotype-mcp-framework = { path = ... }` dep;
  converted all `workspace = true` inheritance to explicit version specs
...
`phenotype-mcp-asset` is the only McpKit crate with **no equivalent in the
PhenoFastMCP family**. Pack handling is intentionally omitted by
