...
This document records the **build state** of `phenotype-mcp-asset` at
extraction time and the **stub-module rationale** for the 5 modules
...
1. Open an issue on `KooshaPari/phenotype-mcp-asset` (after the repo is created — see `ORIGIN.md` for the GitHub-creation blocker)
