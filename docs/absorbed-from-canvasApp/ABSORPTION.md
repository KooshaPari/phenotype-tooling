# Absorbed from canvasApp (post-deletion)

**Source:** `KooshaPari/canvasApp` (archived and deleted from GitHub 2026-06-21)
**Target:** `phenotype-tooling/docs/absorbed-from-canvasApp/`
