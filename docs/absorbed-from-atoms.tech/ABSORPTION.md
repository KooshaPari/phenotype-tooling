# Absorbed from atoms.tech (post-deletion)

**Source:** `KooshaPari/atoms.tech` (archived and deleted from GitHub 2026-06-21)
**Target:** `phenotype-tooling/docs/absorbed-from-atoms.tech/`
