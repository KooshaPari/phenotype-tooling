# Absorbed from phenotype-hub (post-deletion)

**Source:** `KooshaPari/phenotype-hub` (deleted from GitHub 2026-06-21)
**Target:** `phenotype-tooling/docs/absorbed-from-phenotype-hub/`
