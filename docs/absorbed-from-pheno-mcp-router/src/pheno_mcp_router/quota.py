"""Usage quota system for pheno-mcp-router.
...
as substrate-level quota enforcement per ADR-013.
"""
...
_MIN_WINDOW_SECONDS: Final[float] = _config.MIN_WINDOW_SECONDS
...
class QuotaPolicy:
    ...
    window_seconds: float = _config.DEFAULT_WINDOW_SECONDS
