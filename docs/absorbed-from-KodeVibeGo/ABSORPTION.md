# Absorbed from KodeVibeGo (post-deletion)

**Source:** `KooshaPari/KodeVibeGo` (archived and deleted from GitHub 2026-06-21)
**Target:** `phenotype-tooling/docs/absorbed-from-KodeVibeGo/`
