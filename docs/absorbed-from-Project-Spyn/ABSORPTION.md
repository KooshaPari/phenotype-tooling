# Absorbed from Project-Spyn (post-deletion)

**Source:** `KooshaPari/Project-Spyn` (archived and deleted from GitHub 2026-06-21)
**Target:** `phenotype-tooling/docs/absorbed-from-Project-Spyn/`
