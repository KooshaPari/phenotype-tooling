# Absorbed from agslag (post-deletion)

**Source:** `KooshaPari/agslag` (archived and deleted from GitHub 2026-06-21)
**Target:** `phenotype-tooling/docs/absorbed-from-agslag/`
