"""Tests for the :mod:`dispatch_mcp.core.cost` cost calculator.
...
from dispatch_mcp.core.cost import (
    CostCalculator,
    CostEstimate,
    TokenEstimator,
    TokenUsage,
)
from dispatch_mcp.core.tiers import DEFAULT_REGISTRY, UNKNOWN_PRICING
...
def test_calculator_uses_custom_registry() -> None:
    ...
    from dispatch_mcp.core.tiers import TierPricing, TierRegistry
