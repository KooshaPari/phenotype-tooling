# Absorbed from agslag-dash (post-deletion)

**Source:** `KooshaPari/agslag-dash` (archived and deleted from GitHub 2026-06-21)
**Target:** `phenotype-tooling/docs/absorbed-from-agslag-dash/`
