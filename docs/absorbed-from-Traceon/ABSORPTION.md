# Absorbed from Traceon (post-deletion)

**Source:** `KooshaPari/Traceon` (archived and deleted from GitHub 2026-06-21)
**Target:** `phenotype-tooling/docs/absorbed-from-Traceon/`
