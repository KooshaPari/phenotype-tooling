# Absorbed from pheno-specs (post-deletion)

**Source:** `KooshaPari/pheno-specs` (archived and deleted from GitHub 2026-06-21)
**Target:** `phenotype-tooling/docs/absorbed-from-pheno-specs/`
