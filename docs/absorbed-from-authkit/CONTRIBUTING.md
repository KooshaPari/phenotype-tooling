...
Thanks for your interest in contributing to **AuthKit**, part of the [Phenotype](https://github.com/KooshaPari) ecosystem.
...
```bash
git clone https://github.com/KooshaPari/AuthKit.git
cd AuthKit
