# Absorbed from Zerokit (post-deletion)

**Source:** `KooshaPari/Zerokit` (archived and deleted from GitHub 2026-06-21)
**Target:** `phenotype-tooling/docs/absorbed-from-Zerokit/`
