# Absorbed from go-nippon (post-deletion)

**Source:** `KooshaPari/go-nippon` (archived and deleted from GitHub 2026-06-21)
**Target:** `phenotype-tooling/docs/absorbed-from-go-nippon/`
