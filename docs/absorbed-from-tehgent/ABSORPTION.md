# Absorbed from tehgent (post-deletion)

**Source:** `KooshaPari/tehgent` (archived and deleted from GitHub 2026-06-21)
**Target:** `phenotype-tooling/docs/absorbed-from-tehgent/`
