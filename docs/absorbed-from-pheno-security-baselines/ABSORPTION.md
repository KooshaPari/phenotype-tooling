# Absorbed from pheno-security-baselines (post-deletion)

**Source:** `KooshaPari/pheno-security-baselines` (archived and deleted from GitHub 2026-06-21)
**Target:** `phenotype-tooling/docs/absorbed-from-pheno-security-baselines/`
