# Absorbed from thegent-workspace (post-deletion)

**Source:** `KooshaPari/thegent-workspace` (archived and deleted from GitHub 2026-06-21)
**Target:** `phenotype-tooling/docs/absorbed-from-thegent-workspace/`
