# Absorbed from pheno-sdk (post-deletion)

**Source:** `KooshaPari/pheno-sdk` (archived and deleted from GitHub 2026-06-21)
**Target:** `phenotype-tooling/docs/absorbed-from-pheno-sdk/`
