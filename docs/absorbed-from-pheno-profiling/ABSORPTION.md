# Absorbed from pheno-profiling (post-deletion)

**Source:** `KooshaPari/pheno-profiling` (deleted from GitHub 2026-06-21)
**Target:** `phenotype-tooling/docs/absorbed-from-pheno-profiling/`

## Status

Source repository was archived and then deleted on GitHub 2026-06-21.
The local clone was removed after deletion.
...
- The local clone was removed after deletion (no longer recoverable from local disk)
