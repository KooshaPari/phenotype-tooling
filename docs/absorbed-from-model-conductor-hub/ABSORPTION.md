# Absorbed from model-conductor-hub (post-deletion)

**Source:** `KooshaPari/model-conductor-hub` (archived and deleted from GitHub 2026-06-21)
**Target:** `phenotype-tooling/docs/absorbed-from-model-conductor-hub/`

## Status

Source repository was archived and then deleted from GitHub 2026-06-21.
