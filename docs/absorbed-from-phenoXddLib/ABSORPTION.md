# Absorbed from phenoXddLib (post-deletion)

**Source:** `KooshaPari/phenoXddLib` (archived and deleted from GitHub 2026-06-21)
**Target:** `phenotype-tooling/docs/absorbed-from-phenoXddLib/`
