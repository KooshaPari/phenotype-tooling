# Absorbed from agentapi (post-deletion)

**Source:** `KooshaPari/agentapi` (archived and deleted from GitHub 2026-06-21)
**Target:** `phenotype-tooling/docs/absorbed-from-agentapi/`
