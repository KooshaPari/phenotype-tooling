# Absorbed from phenotype-org-governance (post-deletion)

**Source:** `KooshaPari/phenotype-org-governance` (archived and deleted from GitHub 2026-06-21)
**Target:** `phenotype-tooling/docs/absorbed-from-phenotype-org-governance/`
