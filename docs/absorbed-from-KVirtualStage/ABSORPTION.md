# Absorbed from KVirtualStage (post-deletion)

**Source:** `KooshaPari/KVirtualStage` (archived and deleted from GitHub 2026-06-21)
**Target:** `phenotype-tooling/docs/absorbed-from-KVirtualStage/`
