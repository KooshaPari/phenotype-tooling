# Absorbed from argisexec (post-deletion)

**Source:** `KooshaPari/argisexec` (archived and deleted from GitHub 2026-06-21)
**Target:** `phenotype-tooling/docs/absorbed-from-argisexec/`
