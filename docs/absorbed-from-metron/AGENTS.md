...
This file governs work inside the Metron repository.

## Identity

Metron is a [brief description of purpose and role in Phenotype ecosystem].

Do not apply parent shelf instructions (`/Users/kooshapari/CodeProjects/Phenotype/repos/AGENTS.md`) unless explicitly referenced. Work from this directory and treat paths as local to Metron.
