# Absorbed from Dino-fork (post-deletion)

**Source:** `KooshaPari/Dino-fork` (archived and deleted from GitHub 2026-06-21)
**Target:** `phenotype-tooling/docs/absorbed-from-Dino-fork/`
