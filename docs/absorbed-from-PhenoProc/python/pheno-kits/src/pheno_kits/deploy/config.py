...
class DeployConfig:
    ...
    Automatically detects which pheno-sdk packages are used and provides deployment-
    ready configuration.
    """
    ...
    def to_docker_config(self) -> str:
        ...
        """
        return f"""# Generated by pheno-vendor
...
"""
    ...
    def save_configs(self, output_dir: Path | None = None) -> list[Path]:
