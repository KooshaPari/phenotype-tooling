...
class StartupConfig:
    ...
    def __init__(
        self, project_root: Path | None = None, quiet: bool = False, exit_on_failure: bool = True,
    ):
    ...
    def check(self) -> bool:
        ...
        return check_vendor_on_startup(
            project_root=self.project_root, quiet=self.quiet, exit_on_failure=self.exit_on_failure,
        )
