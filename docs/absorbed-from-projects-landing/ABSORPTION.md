# Absorbed from projects-landing (post-deletion)

**Source:** `KooshaPari/projects-landing` (archived and deleted from GitHub 2026-06-21)
**Target:** `phenotype-tooling/docs/absorbed-from-projects-landing/`
