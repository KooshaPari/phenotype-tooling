# Contributing to DevHex

Thanks for your interest in contributing to **DevHex**, part of the [Phenotype](https://github.com/KooshaPari) ecosystem.
...
```bash
git clone https://github.com/KooshaPari/DevHex.git
cd DevHex
go build ./...
go test  ./...
go vet   ./...
