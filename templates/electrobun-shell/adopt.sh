...
echo "Next steps:"
echo "  cd $OUT_DIR"
echo "  bun install          # works on macOS, Windows (x64), and Linux — bun downloads platform-native pre-built binaries from GitHub Releases; no compiler (MSVC/cl.exe) needed"
